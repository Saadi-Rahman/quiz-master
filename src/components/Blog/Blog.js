...
const Blog = () => {
    return (
        <div className='container mb-5 pb-5'>
            ...
            <h3 className='pt-3 text-teal'>React Router</h3>
            <p className='border-start ps-4'>Routing is a process in which a user is directed to different pages based on their action or request. ReactJS Router is mainly used for developing Single Page Web Applications. React Router is used to define multiple routes in the application. When a user types a specific URL into the browser, and if this URL path matches any 'route' inside the router file, the user will be redirected to that particular route. <br /><br />
            ...
            <h3 className='pt-3 text-teal'>React JS useRef Hook</h3>
            <p className='border-start ps-4'>The useRef hook is the new addition in React 16.8. Before proceeding to this article there is a prerequisite to know about the ref in react. The useRef is a hook that allows to directly create a reference to the DOM element in the functional component. <br /><br />
            <h6>Syntax:</h6>
            const refContainer = useRef(initialValue); <br /><br />
